...
export default function HealthMonitor() {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-blue-50 via-green-50 to-yellow-50">
        <AppSidebar />
          ...
          <header className="h-16 border-b border-border flex items-center px-6 bg-gradient-to-r from-blue-600 to-green-600 text-white">
            ...
            <div className="flex items-center gap-4 flex-1">
              <div>
                ...
                <p className="text-sm text-blue-100">Real-time health tracking for your children</p>
              </div>
            </div>
          </header>
